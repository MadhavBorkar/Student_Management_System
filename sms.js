...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.querySelector("#sortAZ").addEventListener("click", sortFunctionAZ);
    document.querySelector("#sortZA").addEventListener("click", sortFunctionZA);
    document.querySelector("#sortByMarks").addEventListener("click", sortFunctionByMarks);
    document.querySelector("#sortByPassing").addEventListener("click", sortFunctionByPassing);
    document.querySelector("#sortByClass").addEventListener("click", sortFunctionByClass);
    document.querySelector("#sortByGender").addEventListener("click", sortFunctionByGender);
});
